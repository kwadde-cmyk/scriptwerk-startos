...
- **Spend-path check** — Descriptor tab → **Check**: tap the devices you have with you. Shows which stage can spend now, which keys are missing, and how many blocks of CSV remain (from Core/Electrum height, or the last UTXO scan).
